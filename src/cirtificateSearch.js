...
const CertificateSearch = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if(searchInput.toLocaleLowerCase()==='cystack.ps'){
  ...
  return (
    <body>
      <div className="container">
        ...
        <span className="whiteongrey">Certificate Search</span>
        <div className="input-container">
          ...
          <form name="search_form" method="GET" onSubmit={handleSubmit}>
            <input type="text" className="input" name="q" size="64" maxLength="255"value={searchInput} onChange={(e)=>setSearchInput(e.target.value)} />
